			...
			if ( ! empty( $bottom_facts ) ) :
				...
				if ( ! empty( $nutrition_facts['additionalNutritionalElements'] ) && is_array( $additional_nutrition_elements ) && ! empty( $additional_nutrition_elements ) ) {
					...
					foreach ( $additional_nutrition_elements as $additional_nutrition_element_key => $additional_nutrition_element_value ) {
						...
						echo '<dt>';
							echo '<strong>' . esc_html( $additional_nutrition_element_value['name'] ) . ' <span class="dr-nut-percent dr-nut-label">' . esc_attr( $nutri_additional_nutritional_elements[ $additional_nutrition_element_key ] ) . '</span>' . esc_attr( $additional_nutrition_element_value['measurement'] ) . '</strong>';
						echo '</dt>';
					}
				}
